...
import _getPrototypeOf from "../getPrototypeOf.mjs";
import _createClass from "../createClass.mjs";
import _possibleConstructorReturn from "../possibleConstructorReturn.mjs";
import _defineProperty from "../defineProperty.mjs";
import _assertThisInitialized from "../assertThisInitialized.mjs";
  ...
  before(function () {
    ...
    B = function () {
      ...
      function B() {
        ...
        var _this = _possibleConstructorReturn(this, _getPrototypeOf(B).apply(this, arguments));
    ...
    C = function () {
      ...
      function C() {
        var _this = _possibleConstructorReturn(this, _getPrototypeOf(C).apply(this, arguments));
